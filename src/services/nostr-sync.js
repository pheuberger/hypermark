 ...
 *
 * Validation functions are in ./nostr-validation.js
 * Yjs state vector utilities are in ./nostr-yjs-state.js
 */
...
// Re-export validation functions so existing imports from './nostr-sync' still work
export {
  VALIDATION_ERRORS,
  NOSTR_KINDS,
...
// Re-export Yjs state vector utilities so existing imports still work
export {
  ...
  getYjsDiff,
  getYjsDiffBase64,
} from './nostr-yjs-state'

// Import NOSTR_KINDS for use within this file
import { NOSTR_KINDS } from './nostr-validation'
// Import validateNostrEvent for use in _handleEventMessage
import { validateNostrEvent } from './nostr-validation'
